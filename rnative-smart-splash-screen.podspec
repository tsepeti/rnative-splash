...
Pod::Spec.new do |s|
  s.name         = "rnative-smart-splash-screen"
  s.version      = package['version']
  s.summary      = "React Native Smart Splash Screen component for Android and iOS"

  s.authors      = { "yasaricli" => "yasaricli@gmail.com" }
  s.homepage     = "https://github.com/tsepeti/rnative-smart-splash-screen"
  s.license      = package['license']
  s.platform     = :ios, "8.0"

  s.source       = { :git => "https://github.com/tsepeti/rnative-smart-splash-screen" }
